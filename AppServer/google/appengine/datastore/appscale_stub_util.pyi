...
def order_property_names(query : datastore_v3_pb2.Query):
    ...
...
class ListCursor(BaseCursor):
    def __init__(self, query : datastore_v3_pb2.Query):
        ...
...
class QueryResult(object):  # TODO fill in remaining type information
    def cursor(self):
        ...
